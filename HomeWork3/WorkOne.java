...
public class WorkOne {
    ...
    if (size < 2)
       return; 
        ...
        // System.out.println("создаем сокращенный array1 с размером половина от исходного" +  Arrays.toString(array1));
       
        int[] array2 = new int[size - half]; 
        // System.out.println("создаем сокращенный array2 с размером половина от исходного путем удаления размера предидущ сокращенного массива" +  Arrays.toString(array2));

        System.arraycopy(array, 0, array1, 0, half);
        // System.out.println("копируем элементы в array1 от 0 до half" +  Arrays.toString(array1));
        
        System.arraycopy(array, half, array2, 0, size - half);
        // System.out.println("копируем элементы в array2 от середины до конца" +  Arrays.toString(array2));
